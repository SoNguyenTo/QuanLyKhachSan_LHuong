...
namespace QuanLyKhachSan
{
    public partial class FormSDDV : Form
    {
        ...
        private SqlConnection conn; //kết nối cơ sở dữ liệu
        ...
        public void connect()
        {
            String conStr = globalParameter.str;  //str: chuyển 1 biến dạng số hay kết quả về dạng chuỗi.
            try
            {
        ...
        {
            conn.Close();
            conn.Dispose();//hủy đối tượng giải phóng tài nguyên
            conn = null;
        }
