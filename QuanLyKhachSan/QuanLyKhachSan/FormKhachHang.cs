...
namespace QuanLyKhachSan
{
    ...
    public partial class FormKhachHang : Form
    {
        ...
        //đổ dữ liệu từ csdl vào Datagrid hiển thị Mã KH, Tên KH, GT, NS, số cmnd
        ...
        public void getHinhThuc()
        {
            ...
            SqlCommand cm = new SqlCommand();//dùng để thực hiện câu lệnh SQL hoặc thủ tục nội tại (stored procedure)
